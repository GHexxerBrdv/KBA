...
import {
  SpinnerIcon
} from "./chunk-ZHQWTWVF.js";
import {
  IconBase,
  Ripple
} from "./chunk-HOLDBCUE.js";
import {
  Portal,
  Tooltip
} from "./chunk-FGDB2ANR.js";
import {
  ComponentBase,
  useDebounce,
  useEventListener,
...
var CSSTransition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react3.default.createElement(Transition_default, _extends4({}, props, {
...
CSSTransition.propTypes = true ? _extends4({}, Transition_default.propTypes, {
  /**
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state2) {
        var children2 = _extends4({}, state2.children);
...
var SearchIcon = React11.memo(React11.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React11.createElement("svg", _extends5({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var VirtualScroller = React12.memo(React12.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React12.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React12.useState(props.numToleratedItems), _React$useState10 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React12.useState(props.loading || false), _React$useState12 = _slicedToArray(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React12.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React12.createElement(SpinnerIcon, _extends6({}, loadingIconProps, {
      spin: true
    }));
...
var DropdownItem = React14.memo(function(props) {
  ...
  return React14.createElement("li", _extends8({
    key: props.label
...
var DropdownPanel = React14.memo(React14.forwardRef(function(props, ref) {
  ...
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      ...
      return React14.createElement(VirtualScroller, _extends8({
  ...
  var createElement9 = function createElement10() {
    ...
    return React14.createElement(CSSTransition2, _extends8({
      nodeRef: ref
    }, transitionProps), React14.createElement("div", _extends8({
      ref
    }, panelProps), props.firstFocusableElement, filter, content, footer, props.lastFocusableElement));
  };
  var element = createElement9();
...
var Dropdown = React14.memo(React14.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React14.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React14.useState(-1), _React$useState4 = _slicedToArray2(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React14.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
  ...
  return React14.createElement(React14.Fragment, null, React14.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React14.createElement(DropdownPanel, _extends8({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    sx
  }))), hasTooltip && React14.createElement(Tooltip, _extends8({
    target: elementRef,
